...
const init_phones = ["Generic JM-1", "AudioSense AQ4 - Velvets"], // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
...
const targets = [
    {files:["Generic JM-1", "Generic Delta"]},
];
...
const  preference_bounds = "assets/images/bounds.png", // Preference bounds image
       ...
       tiltableTargets = ["Generic JM-1", "Generic Delta"];// Targets that are allowed to be tilted
...
let headerLogoText = "ted the praimortis",
