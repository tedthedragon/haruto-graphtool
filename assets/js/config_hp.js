...
const init_phones = ["KEMAR DF for KB-500x Target"],         // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      page_title = "ted the praimortis",            // Optional. Appended to the page title if share URLs are enabled
